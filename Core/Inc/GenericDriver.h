...
#ifndef INC_GENERICDRIVER_H_
#define INC_GENERICDRIVER_H_
...
#define FLAGS_RESERVED                 0xf0
#define FLAGS_APPLICATION_SPECIFIC     0x0f
#define FLAGS_NONE                     0

// Default timeout for waitCAD() in ms
#define CAD_DEFAULT_TIMEOUT            10000
...
public:
  ...
  virtual bool            waitAvailableTimeout(uint16_t timeout, uint16_t polldelay = 0);
    ...
    virtual void           setHeaderFlags(uint8_t set, uint8_t clear = FLAGS_APPLICATION_SPECIFIC);
